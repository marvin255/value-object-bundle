...
final class ValueObjectTypeTest extends BaseCase
{
    public function testGetNameToClassMap(): void
    {
        $expected = [
            ...
            'marvin255_negative_integer' => IntNegativeValueObjectType::class,
            'marvin255_non_negative_integer' => IntNonNegativeValueObjectType::class,
            'marvin255_non_positive_integer' => IntNonPositiveValueObjectType::class,
            'marvin255_float' => FloatValueObjectType::class,
            'marvin255_percentage' => PercentageValueObjectType::class,
            'marvin255_bc_math_number' => BcMathNumberValueObjectType::class,
        ];

 ...
 * @internal
 */
final class IntValueObjectTypeTest extends BaseCase
{
    public function testGetName(): void
    {
        $type = new IntValueObjectType();

        $this->assertSame(ValueObjectType::INTEGER->value, $type->getName());
    }
    ...
    {
        $value = 123;
        $valueObject = new IntValueObject($value);
